...
function SettingsSidebar({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex justify-end animate-fade-in" onClick={onClose}>
      <div 
        className="bg-[#0e1626] border-l border-slate-800/80 w-full max-w-[320px] h-full p-6 shadow-2xl flex flex-col justify-between animate-slide-in-right" 
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="flex items-center justify-between pb-3.5 border-b border-slate-800">
            ...
            <Button 
              ...
              variant="secondary" 
              size="icon" 
              className="w-8 h-8 rounded-full border border-slate-800/60 hover:bg-slate-800 transition-colors"
            >
          ...
          <div className="p-3.5 bg-slate-900/60 border border-slate-800/80 rounded-2xl flex flex-col gap-1.5 shadow-inner">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{t("dbStatus")}</span>
            ...
            {lastSaved && (
              <div className="flex items-center justify-between border-t border-slate-800/60 pt-1.5 mt-0.5">
          ...
          <div className="space-y-2.5 pt-4 border-t border-slate-800">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                variant="secondary"
                className="w-full h-11 text-xs font-bold flex items-center justify-start gap-3 px-4 bg-slate-900/60 border border-slate-800/80 hover:bg-slate-800 hover:border-slate-700 text-slate-200 transition-all rounded-xl"
              >
        ...
        <div className="max-w-7xl mx-auto w-full flex items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-500/5 via-slate-850/20 to-amber-500/0 hover:from-emerald-500/10 hover:to-emerald-500/5 shadow-md hover:shadow-emerald-950/20 hover:scale-105 active:scale-95 group transition-all duration-300"
            >
