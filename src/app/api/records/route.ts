...
export async function POST(request: Request) {
  try {
    ...
    const { income, expense, donation, withdraw, investment, reinvestment, returnedCash, savedTotals, notes, assets, calcHistory } = body;
