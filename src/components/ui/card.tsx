...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-border/80 bg-surface text-text-primary shadow-xl glass-panel overflow-hidden transition duration-200",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-xs text-text-muted font-semibold", className)}
    {...props}
  />
));
